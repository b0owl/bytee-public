#!/usr/bin/env python3
"""
Generate dist/bytee_single.h — a stb-style single-header amalgam of the bytee engine.
...
out.append("""\
// ================================================================
//  bytee_single.h  —  single-header amalgam of the bytee engine
...
# Engine source files
for src_file in ['allocator.cpp', 'rendering.cpp', 'window.cpp']:
...
output_path = os.path.join(DIST, 'bytee_single.h')
